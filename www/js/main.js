...
/*video popup control============================================ */
$('.sect3 .sectWrap .videoContent .videoWrap .real a.play').click(function(ev){
    $('.videoPopup').css({"right":"0%"})
    $('.videoPopup .videoPopupWrap').css({"opacity":"1"})
...
var sectNum=1,//Throttle switch
    ...
    scrollLock=1,//scroll lock switch
